  ...
  return(
    <div>
      <form onSubmit={newLocationSubmit}>
        <span>Manager:</span>
        <input name="manager" type="string" placeholder="Manager name" onChange={(event) => setAddress(event.target.value)}></input>
        <br/><span>Address:</span>
        <input name="address" type="string" placeholder="Location address" onChange={(event) => setManager(event.target.value)}></input>
        <br/><span>Phone:</span>
        <input name="phone" type="string" placeholder="Phone number" onChange={(event) => setPhone(event.target.value)}></input>
